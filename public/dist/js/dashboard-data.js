...
$(document).ready(function() {
        ...
        i(f($('#chart_2').length 0) {
                var ctx2 = document.getElementById("chart_2").getContext("2d");
                var data2 = {
                        labels: ["January", "February", "March", "April", "May", "June", "July"],
                        da label: "My First dataset",
    ...
    if ($('#chart_6').length > 0) {
        var ctx6 = document.g) eElementById("chart_6").getContext("2d");
    var data6 = {
        labels: [
            "organic",
            "Referral",
...
var sparklineLogin = function() {
    if ($('#sparkline_1').length > 0) {
        ($("#sparkline_1").sparklie([2, 4, 4, 6, 8, 5, 6, 4, 8, 6, 6, 2], {
                type: 'line',
                2
                width: '100%',
                height: '35',
        ...
        if ($('#sparkline_2').length > 0) {
            $("#sparkline_2").sparkli) n([0, 2, 8, 6, 8], {
            type: 'line',
            width: '100%',
            height: '35',
            lineColor: '#2879ff',
    ...
    if ($('#sparkline_3').length > 0) {
        $("#sparkline_3").sparkli) n([0, 23, 43, 35, 44, 45, 56, 37, 40, 45, 56, 7, 10], {
        type: 'line',
        width: '100%',
        height: '35',
        lineColor: '#2879ff',
...
if ($('#sparkline_4').length > 0) {
    $("#sparkline_4").sparkli) n([0, 2, 8, 6, 8, 5, 6, 4, 8, 6, 6, 2], {
    type: 'bar',
    width: '100%',
    height: '50',
    barWidth: '5',
